...
<div class="hero">
  ...
  <div class="button-group">
    <a href="/pages/sea-level-rise" class="cta-button">Map View: Sea Level Rise → </a>
    <a href="/pages/sea-level-over-time" class="cta-button">Line Graph: Sea Level Projections → </a>
  </div>
</div>
